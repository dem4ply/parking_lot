...
coverage: ## check code coverage quickly with the default Python
	coverage run --source parking_lot setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/parking_lot.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ parking_lot
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics parking_lot tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes parking_lot tests
